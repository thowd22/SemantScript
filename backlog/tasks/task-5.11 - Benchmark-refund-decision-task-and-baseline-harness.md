...
- [ ] #5 Held-out set includes a slice of real, human-authored cases not generated by any teacher, and accuracy is reported separately on that slice
- [ ] #6 Laya (laya-typed-decisions checkpoint) is included as a baseline with the same inputs
<!-- AC:END -->
